...
// @author       You
// @match        t66y.com/*
// @updateURL    https://fullrss.ddns.net/scripts/clLinkTransfer.user.js
// @downloadURL  https://fullrss.ddns.net/scripts/clLinkTransfer.user.js
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    function triggerRemoteDownload(hashCode)
    {
        ...
        request.open("POST", "https://bloghz.ddns.net/cmd/rmdown");
